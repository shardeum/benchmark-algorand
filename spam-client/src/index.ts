...
export async function establishConnection(): Promise<void> {
  const algodToken = '00b16e3eef9d265e98c04a99e9c275dcf9609a7a6bd0b440f8479f1057d1526b';
  const algodServer = 'http://localhost';
  const algodPort = 45771;
...
const spam = async (argv: spamOptions) => {
  ...
  for (let i = 0; i < txCount; i++) {
    ...
    // console.log(tx)
    try {
      algodClient.sendRawTransaction(signedTxs[i]).do().catch(e => { console.log(e.message) });
    } catch (e) {
